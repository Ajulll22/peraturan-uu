                    ...
                    <form action="{{ route('account.store') }}" method="POST">
                        ...
                        <div class=" pb-2 grid md:grid-cols-2 lg:grid-cols-2 gap-5">
                            <div class="grid">
                                ...
                                <input type="text" name="name" class="p-1 input-rounded-cyan border text-sm border-cyan-600/40" value="{{ old('name') }}" autofocus>
                            </div>
                            <div class="grid">
                                <label for="email" class="text-sm">Email</label>
                                <input type="email" name="email" class="p-1 input-rounded-cyan border text-sm border-cyan-600/40" value="{{ old('email') }}">
                            </div>
                            <div class="grid">
                                <label for="password" class="text-sm">Password</label>
                                <input type="password" name="password" class="p-1 input-rounded-cyan border text-sm border-cyan-600/40" value="{{ old('password') }}">
                            </div>
                            <div class="grid">
