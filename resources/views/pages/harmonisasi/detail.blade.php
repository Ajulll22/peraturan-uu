    ...
    <div class="grid lg:grid-cols-2 rounded-md shadow-xl">
        ...
        <div class="p-5 bg-slate-100">
            ...
            <div class="grid gap-2 divide-y divide-slate-300">
                ...
                <div id="match-pasal" >
                    @foreach($pasals->hasil as $row)
                    <div class='py-3'>
                        <a data-bs-toggle='collapse' href='#collapseExample{{ $row->id }}' role='button' aria-expanded='false' aria-controls='collapseExample'>
                            <div class='grid grid-cols-[1fr_auto] gap-2'>
                                <div class=''>
                                    <div class='text-lg font-bold capitalize'>{{str_replace('~', ' ',$row->uud_id)}}</div>
                                    <div class='text-sm capitalize'>{{$row->presentase}}%</div>
                                </div>
                        ...
                        <div class='collapse' id='collapseExample{{ $row->id }}'>
                            <div class='pt-4'>
                                <?php $row->uud_content = preg_replace("/\r\n|\r|\n/", "<br>", $row->uud_content); ?>
                                <?php echo ($row->uud_content) ?>
